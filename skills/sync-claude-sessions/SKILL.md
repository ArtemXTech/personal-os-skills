...
description: Sync Claude Code or Codex sessions to Obsidian markdown. Export, resume, add notes, close sessions. USE WHEN user says "sync sessions", "export sessions", "resume session", "add session note", "close session", "log session".
---

# Sync Claude Sessions

Export Claude Code or Codex conversations to Obsidian for observability and analysis.
...
- Frontmatter: `type`, `agent_backend`, `date`, `session_id`, `title`, `summary`, `skills`, `messages`, `status`, `tags`, `rating`, `comments`
